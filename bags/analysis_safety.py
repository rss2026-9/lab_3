...
TOPIC_NAME = "/safety_error"

TRIM_START_SEC = 0    # ignore first 2 seconds
TRIM_END_SEC = None       # example: 15.0 to stop at 15 sec, or None for full bag
...
def main():
    ...
    plt.xlabel("Time (s)")
    plt.ylabel("Safety Stopping Distance Error (m)")
    plt.title("Stopping Distance Error vs Time")
    plt.grid(True)
    plt.savefig("safety_2_5.png")
